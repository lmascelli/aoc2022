/*
Leonardo Mascelli.
Advent of Code 2022 day 4 pt 1

Each line contains two pairs of number in the form x0-x1,y0-y1
the goal is to count how many times a range is contained in the other
 */
...
int main(int argc, char *argv[]) {
  ...
  while(true){
    ...
    count += (r1[0]>=r2[0] and r1[1]<=r2[1]) or (r2[0]>=r1[0] and r2[1]<=r1[1]);
  }
  cout << count << endl;
  ifs.close();
  return 0;
